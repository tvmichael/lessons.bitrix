...
//-----------------------
Bitrix\Main\Diag\Debug::writeToFile(array('S' => 1, 'P'=>$arParams ),"","logfile.txt");
...
)
{
	...
	for($i = 0; $i < $arParams["NUM_CATEGORIES"]; $i++)
	{
		...
		$obTitle->Search(array("QUERY"=>$str_query), array('property_'.$arParams["ORDER"]), $exFILTER);
		...
		*/
        ...
        //-----------------------
        Bitrix\Main\Diag\Debug::writeToFile(array('S-NUM_CATEGORIES' => 1, 'R'=>$arResult ),"","logfile.txt");
	}
	...
	if($arParams["SHOW_OTHERS"] === "Y")
	{
		...
		$obTitle->Search(array("QUERY"=>$str_other_query), array('property_'.$arParams["ORDER"]), $arOthersFilter);
			while($ar = $obTitle->Fetch())
			{
                //-----------------------
                Bitrix\Main\Diag\Debug::writeToFile(array('S-F' => '1-F2', 'A'=>$ar ),"","logfile.txt");
        ...
        //-----------------------
        Bitrix\Main\Diag\Debug::writeToFile(array('S-SHOW_OTHERS' => 1, 'R'=>$arResult ),"","logfile.txt");
	...
	if(!empty($arResult["CATEGORIES"]))
	{
		...
		*/
        ...
        //-----------------------
        Bitrix\Main\Diag\Debug::writeToFile(array('S-CATEGORIES' => 2, 'R'=>$arResult ),"","logfile.txt");
	}
}
...
//-----------------------
Bitrix\Main\Diag\Debug::writeToFile(array('S' => 2, 'R'=>$arResult ),"","logfile.txt");
