...
<?
if ( $USER->IsAdmin() && $USER->GetID()==291 )
{
    echo "<pre  style='background-color: white;' data-mv='local-templates-aspro_optimus_ssk-components-bitrix-catalog.smart.filter-main-template.php'>";
    print_r($arResult);
    echo "</pre>";
}
?>
