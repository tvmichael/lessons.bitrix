...
Debug::writeToFile(array( '___script_for_editor_date'=>date("H:i:s") ), "", "/bitrix/tmp/log_mv.log");
// ----------------------------------------------------------------

?>
<script>

    console.log('--- 0 script_for_epilog.js');
...
window.FCForm.prototype = {
    ...
    submitCommentT: function(){ /* ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
        console.log('--- 5>1 submitCommentT:');
        console.log(this);


        var text = (this.handler.editorIsLoaded ? this.handler.oEditor.GetContent() : 'MIK!!!');
        ...
        console.log('--- 5>2 submitCommentT:');
	...
	submit : function() {
        ...
        //>>>>>>>>>>>>>>>>>
        var nowMIK = new Date();
        var testMIK = 'TEXT-MIK: '+ nowMIK;
        console.log('--- 6 : '+ testMIK);
        ...
        //>>>>>>>>>>>>>
        console.log('submit : window.convertFormToArray');
        //post_data['comment'] = testMIK;
        console.log(post_data);
...
{
    console.log('--- 8 __window.editCommentNew:');
    console.log(key);
    console.log(postId);
...
{
    console.log('--- 9 __window.editCommentNew:');
